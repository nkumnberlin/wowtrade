...
import {Category, ICraftingData, ProfessionSkillTree, ProfessionSkillTreeResponse} from "./types";
...
import professionMap from "../assets/professionCalls.json";
 ...
 const saveAllProfessions = async () => {
	 ...
	 const allProfessions = allProfessionsResponses.map<ProfessionSkillTree>((professionResponse) => ({
...
export const getAllProfessionSkillTrees = async () => prisma.professionSkillTree.findMany() as PrismaPromise<Array<ProfessionSkillTree>>
